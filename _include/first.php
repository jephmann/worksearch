<?php
    ...
    $img_linkedin   = Format::image($link_img.'linkedin.png','LinkedIn');
    $img_twitter    = Format::image($link_img.'twitter.png','Twitter');
    $img_facebook   = Format::image($link_img.'facebook.png','Facebook');
    $img_googleplus = Format::image($link_img.'linkedin.png','Google+');    
    // status message
